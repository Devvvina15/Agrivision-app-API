...
router.get('/forecast', async (req, res) => {
    ...
    try {
        ...
        const response = await axios.get(`https://api.openweathermap.org/data/2.5/forecast`, {
            params: {
                q: city, // Menggunakan parameter 'q' untuk nama kota
        ...
        // Kirim respons JSON dalam Bahasa Indonesia
        res.json({
            kota: `${cityName}, ${country}`, // Nama kota dan negara
            ramalan: result, // Data ramalan cuaca
        });
    } catch (error) {
